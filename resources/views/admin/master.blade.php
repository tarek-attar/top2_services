...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseServise"
                    aria-expanded="true" aria-controls="collapseServise">
                    <i class="fas fa-fw fa-heart"></i>
                    <span>{{ __('site.All-Services') }}</span>
                </a>
                <div id="collapseServise" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"
                            href="{{ route('admin.services.index') }}">{{ __('site.All-Services') }}</a>
                        <a class="collapse-item"
                            href="{{ route('admin.services.create') }}">{{ __('site.Add-New') }}</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseNews" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"
                            href="{{ route('admin.newses.index') }}">{{ __('site.All-News') }}</a>
                        <a class="collapse-item"
                            href="{{ route('admin.newses.create') }}">{{ __('site.Add-New') }}</a>
                    </div>
                </div>
            </li>
